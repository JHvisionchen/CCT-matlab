function labels = gaussian_concave_labels(sigma, sz, lower_bound, upper_bound)
...
% 	labels(1,1) = magnitude;  %label for 0-shift (original sample)
    ...
    upper_labels = (1-labels)*upper_bound;
    lower_labels = labels*lower_bound;
    labels = max(upper_labels, lower_labels);
